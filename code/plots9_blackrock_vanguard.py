...
# %%
df=pd.read_parquet(f_betas,columns=['mgrno','permno','quarter','beta','permno_drop','sharecode_drop'])
...
df.loc[df['mgrno_merger'].isin(is_blackrock.union(is_vanguard)),'mgrno_merger']=1139734
...
plt.legend(['$\kappa$: Actual Ownership','$\kappa$: Merger: BlackRock+Vanguard','$\kappa$: Split in Half: BlackRock+Vanguard','$\kappa$: Ignore: BlackRock+Vanguard'])
plt.xlabel("")
plt.ylim(0,1)
