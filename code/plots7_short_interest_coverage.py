...
# %%
tmp=pd.merge(df.groupby(['permno','quarter']).agg({'beta':sum, 'shares': sum, 'shares_outstanding': max}).reset_index(),df_short,left_on=['permno','quarter'],right_on=['lpermno','qdate'],how='left')
